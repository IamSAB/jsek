<template>
  <header class="mb-12">
    <svg-section
      ...
      bg-after="var(--color-lightgray-lighter)"
      bottom-svg="triangle"
    >
      <div class="flex justify-between">
        <div class="m-3" v-if="postId">
          ...
          <ul class="flex">
            <li v-for="(item, index) in socials" :key="index" class="mx-2">
              <factor-link
                ...
                :path="item.url"
                target="_blank"
                class="text-sm tracking-tighter text-white"
              >
      ...
      <div class="flex flex-col sm:flex-row items-center justify-center mb-3">
        <widgets
          position="navbarLeft"
          class="flex flex-row sm:flex-col md:flex-row items-end mt-5 sm:m-0"
        />
        <svg
          class="order-first sm:order-none stroke-current text-white h-32 mx-5"
          viewBox="0 0 64 64"
        >
          <g transform="translate(0 -280.1)">
            ...
            <g fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="1px">
              <g>
                ...
                <path
                  d="M21.24 296.6s-1.37-.044-1.602 1.37c-.232 1.414 2.398 3.392 3.359 2.276.961-1.116-.586-2.265-.586-2.265l-.652.64"
                />
                <path
                  d="M25.6 294s-1.668.1-1.271 1.381c.398 1.282 2.044.652 2.353 1.823s-1.295 1.345-1.295 1.345"
                />
                ...
                <path
                  d="M41.37 300.8l2.917-3.127s1.867 1.282.895 2.166c-.972.884-2.32-.639-2.32-.639 1.032 1.831.11 3.191.11 3.191"
                />
              ...
              <g>
                ...
                <path
                  d="M46.4 311.1l4.64-.055s.23 2.312-.994 2.298c-1.224-.014-1.171-2.232-1.171-2.232s-.266 2.232-1.47 2.22c-1.203-.01-1.004-2.231-1.004-2.231"
                />
                ...
                <path
                  d="M24.05 324.6l-2.584 3.9s-1.896-1.102-1.114-2.399c.782-1.296 2.571.2 2.571.2"
                />
                <path
                  d="M19.8 320.6l1.076 1.367-1.726 1.346-.798-1.04.798 1.04-1.714 1.29-1.07-1.378"
                />
        ...
        <widgets position="navbarRight" class="flex flex-row sm:flex-col md:flex-row my-2 sm:my-0" />
      </div>
